...
if(detectIE() != false){
    $('body').append("<div class='IE'><h1>Unfortunately this browser is outdated</h1><h1>Please use any of these supported browsers</h1><h3>Chrome</h3><h3>Firefox</h3><h3>Safari</h3><h3>Android</h3><h3>Opera</h3></div>");
...
function checkMenu(){
    ...
    if($("body").hasClass("fp-viewing-MadGiant-Home")){
        $("#HorizontalMenu").hide();
        buttoncheck();
...
$(document).ready(function() {
    if($(".pc").css("display") === "none"){
        ...
        menu: '#menu',
        lockAnchors: false,
        anchors:['MadGiant','home_mob','story_mob','our_beers_mob','chow_at_mg_mob','tasting_room_mob','giant_store_mob','events_mob','contact_mob'],
        navigation: false,
...
$(".giantevent").appendTo(".mobile_events");
...
$("#Bottle").appendTo(".hop_beer_mob");
$("#Killer_Hop").appendTo(".hop_beer_mob");
$("#beer_details #Beer_Categories").clone().appendTo(".mob_hop_details");
$("#beer_details #Killer_Hop_Details").appendTo(".mob_hop_details");
 
$("#Bottle").clone().appendTo(".guzzler_beer_mob");
$("#The_Guzzler").appendTo(".guzzler_beer_mob");
...
$("#Bottle").clone().appendTo(".grit_beer_mob");
$("#True_Grit").appendTo(".grit_beer_mob");
$("#beer_details #Beer_Categories").clone().appendTo(".mob_grit_details");
    $("#beer_details #True_Grit_Details").appendTo(".mob_grit_details");
    
$("#Bottle").clone().appendTo(".electric_beer_mob");
$("#Electric_Light").appendTo(".electric_beer_mob");
...
$("#OURBEERSMOBILE_1_").click(function(){
    $.fn.fullpage.moveTo('our_beers_mob');
    menutoggle();
})
...
$("#CHOWDOWNMOBILE").click(function(){
    $.fn.fullpage.moveTo('chow_at_mg_mob');
    menutoggle();
...
$("#TASTINGROOMMOBILE").click(function(){
    $.fn.fullpage.moveTo('tasting_room_mob');
    menutoggle();
...
$("#BUYMERCHMOBILE").click(function(){
    $.fn.fullpage.moveTo('giant_store_mob');
    menutoggle();
})
...
function NextBeerMob(){
    if($(".mobile_beers_hop").hasClass("active")){
        $.fn.fullpage.moveTo('our_beers_mob', '1');
        $(".BeerPrevMob").show();

    }else if($(".mobile_beers_guzzler").hasClass("active")){
        $.fn.fullpage.moveTo('our_beers_mob', '2');

    }else if($(".mobile_beers_grit").hasClass("active")){
        $.fn.fullpage.moveTo('our_beers_mob', '3');
        $(".BeerNextMob").hide();
...
function PrevBeerMob(){
    if($(".mobile_beers_electric").hasClass("active")){
        $.fn.fullpage.moveTo('our_beers_mob', '2');
        $(".BeerNextMob").show();
        ...
        $.fn.fullpage.moveTo('our_beers_mob', '0');
        $(".BeerPrevMob").hide();
...
$(".BeerNextMob").click(function(){
    NextBeerMob();
})

$(".BeerPrevMob").click(function(){
    PrevBeerMob();
})
...
function scaledownstory1(){
  $("#BeerStand, #Giant1toggle, #beer1toggle").addClass("scaledownstory");
...
function removescaledownstory1(){
  $("#BeerStand, #Giant1toggle, #beer1toggle").removeClass("scaledownstory");
...
function checkArr($a, $b){
        ...
        if($("body").hasClass("fp-viewing-MadGiant-Chow_at_MG")){
            $(".logo").fadeOut(200);
        }else{
            $(".logo").fadeIn(200);
        }
...
function buttoncheck() {
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Story")){
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Our_Beers")){
        $(".beer_container").fadeOut(300);
        $("#HorizontalMenu g:nth-of-type(6) polyline").css("stroke-dashoffset",""); 
    }else{
        $(".beer_container").fadeIn(300);
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Tasting_Room")){
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Giant_Store")){
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Events")){
    ...
    if(!$("body").hasClass("fp-viewing-MadGiant-Contact")){
...
function selectedCheck($a){
  if($("body").hasClass("fp-viewing-MadGiant-"+$a+"")){
...
$(".home_beers").click(function(){
    checkArr("Our_Beers");
    buttoncheck();
})

$(".home_chow").click(function(){
    checkArr("Chow_at_MG");
    buttoncheck();
})
...
$(".home_merch").click(function(){
    checkArr("Giant_Store");
    buttoncheck();
})
...
$(".1_Beer").click(function(){
    if($(".guzzler_bground").hasClass("selected")){
        ...
        $(".beer_info_container1").fadeIn(300);
...
$(".2_Beer").click(function(){
    if($(".killer_bground").hasClass("selected")){
        ...
        $(".2_Beer").addClass("beer_menu_selected");
        ...
        $(".beer_info_container2").fadeIn(300);
...
$(".3_Beer").click(function(){
    if($(".guzzler_bground").hasClass("selected")){
        ...
        $(".3_Beer").addClass("beer_menu_selected");
        ...
        $(".beer_info_container3").fadeIn(300);
...
$(".4_Beer").click(function(){
    if($(".guzzler_bground").hasClass("selected")){
        ...
        $(".4_Beer").addClass("beer_menu_selected");
        ...
        $(".beer_info_container4").fadeIn(300);
...
setTimeout(ThreeRight,50);
    ...
    function MoboBeers(el,d) {
      if(d==="u"){
          $("#EatMG, #EatUrban").show();
      }     
setTimeout(MoboBeers,50);
    }

 detectswipe('MoboBeers',MoboBeers);
...
$(".BackToMadGiant").click(function(){
    console.log("no");
    $(".appendToThis").fadeIn(200);
...
function ExeMenu(){
    $.get("menu2.html", function (data){
                    $(".appendToThis").append(data);
                });
}

$(".UrbanologiWebsite").click(function(){
    window.open("http://www.urbanologi.co.za/");
